...
#         self.color_index = 0
#         self.placeholder = self.expander.empty()
...
#                 f'<span style="color:{self.colors[self.color_index]}">Entering new CrewAgentExecutor chain</span>'
#             )

#         if "Forschungsexperte" in cleaned_data:
#             cleaned_data = cleaned_data.replace(
#                 "Forschungsexperte",
#                 f'<span style="color:{self.colors[self.color_index]}">Forschungsexperte</span>'
#             )
#         if "Zusammenfassungsanalyst" in cleaned_data:
#             cleaned_data = cleaned_data.replace(
#                 "Zusammenfassungsanalyst",
#                 f'<span style="color:{self.colors[self.color_index]}">Zusammenfassungsanalyst</span>'
#             )

#         self.buffer.append(cleaned_data)
#         if "\n" in data:
#             content = ''.join(self.buffer)
#             self.placeholder.markdown(f'<div style="font-size: 0.9em">{content}</div>', unsafe_allow_html=True)
#             self.buffer = []
